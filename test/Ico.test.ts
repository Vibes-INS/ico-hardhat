...
describe('Ico', () => {
  ...
  it('should allow investor to contribute', async () => {
    ...
    assert.equal(amount, await investor.getAddress())
  })
  ...
  it('allows investor to approve payments', async () => {
    ...
    await ownerContract.createPayment('Rent Office', 2000, await receiver.getAddress())
    ...
    assert.equal<BigNumber | number>(balanceDiff, 2000)
  })
})